<template>
    <div>
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-3xl font-bold">Histórico Global de Jogos</h1>
        ...
        >
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    >
                        <tr v-for="game in mockGames" :key="game.id">
                            <td
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-2 py-1 bg-primary-100 dark:bg-primary-900/20 text-primary-800 dark:text-primary-200 text-xs font-semibold rounded"
                                >
                                    {{ game.variant }}
                                </span>
                            </td>
