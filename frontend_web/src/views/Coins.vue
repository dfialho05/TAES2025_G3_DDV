<template>
    <div class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <!-- Current Balance -->
            <div
                class="bg-gradient-to-br from-yellow-400 to-yellow-600 text-white rounded-xl shadow-lg p-6"
            >
            ...
            <!-- Buy Coins CTA -->
            <div
                class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700 flex items-center justify-between"
            >
                <div>
        ...
        >
            <div
                class="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-md w-full"
                @click.stop
            >
                ...
                <div class="space-y-3 mb-6">
                    ...
                    >
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                v-if="pack.bonus"
                                class="px-2 py-1 bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-200 text-xs font-semibold rounded"
                            >
                                +{{ pack.bonus }} bónus
                            </div>
                        </div>
...
import { useTransactionsStore } from "../stores/mocks/transactions";
...
function completePurchase() {
    if (selectedPack.value) {
        const totalCoins =
            selectedPack.value.coins + (selectedPack.value.bonus || 0);
