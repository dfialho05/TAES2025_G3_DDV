<template>
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Filters -->
        <div
            class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-200 dark:border-gray-700 mb-6"
        >
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <span
                                class="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 rounded-full"
                            >
                                {{ game.mode }}
                            </span>
                        </div>
                        ...
                        <div
                            class="grid grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-400"
                        >
                            <div>
