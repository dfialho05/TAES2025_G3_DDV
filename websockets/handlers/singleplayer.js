...
const botPlay = (cardPlayed, botHand, trump, assistNeeded, suitsCounts) => {
  // If no card was played, bot is first to play (lead)
  if (!cardPlayed) {
    return chooseBestLead(botHand, trump, assistNeeded, suitsCounts);
  }

  // If a card was played, bot is second to play (response)
  return chooseBestResponse(cardPlayed, botHand, trump, assistNeeded);
};
